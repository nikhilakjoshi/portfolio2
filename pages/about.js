  ...
  return (
    <div className="aboutme">
        ...
        >
          ...
          <div className="pwrapper text-gray-600 text-lg leading-relaxed w-10/12">
            <p className="">
              ...
              now. I just have to say it, I absolutely love making websites look
              amazing.
            </p>
            <br />
            <p>
              I was a software engineer in my past life, fixing and building top
              notch stuff to other people’s credit.
            </p>
            <br />
            <p>
      ...
      <motion.div
        ...
        initial="baseInitial"
        animate="Final"
        className="flex max-w-screen-xl mx-auto py-4"
      >
        <img
          src="/prof_pic.jpg"
          alt="Profile Picture Nikhil Joshi"
        ...
        <div className="my-5 flex flex-col px-8">
          ...
          <p className="text-sec text-xs">
            I’m an avid self learner, but these companies taught me how to learn
          </p>
        </div>
      </motion.div>
    </div>
